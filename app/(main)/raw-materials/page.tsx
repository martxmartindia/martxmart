      ...
      <header className="bg-gradient-to-r from-brand-900 to-brand-800 text-primary-foreground py-20 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-5xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Source high-quality raw materials and supplies with reliability and efficiency.
          </p>
          <Link
            href="#contact"
            ...
            aria-label="Explore Our Supplies"
          >
            Explore Our Supplies
          </Link>
        </div>
      </header>
            ...
            {[
              {
                ...
                description: 'Access premium raw materials from trusted global suppliers.',
              },
              {
                title: 'Supply Chain Management',
                description: 'Streamlined logistics to ensure timely delivery.',
              },
              {
                title: 'Custom Orders',
                description: 'Tailored material solutions to meet your specific needs.',
              },
            ].map((service, index) => (
              <motion.div
                key={index}
