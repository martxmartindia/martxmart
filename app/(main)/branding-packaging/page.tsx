      ...
      <header className="bg-gradient-to-r from-brand-900 to-brand-800 text-primary-foreground py-20 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-5xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Elevate your brand with stunning designs and innovative packaging that captivates customers.
          </p>
          <Link
            href="#contact"
            ...
            aria-label="Start Your Brand Journey"
          >
            ...
            {[
              {
                ...
                description: 'Craft a unique logo and visual identity that reflects your brand’s essence.',
              },
              {
                title: 'Packaging Solutions',
                description: 'Design sustainable, eye-catching packaging that stands out on shelves.',
              },
              {
                title: 'Marketing Collateral',
                description: 'Create brochures, banners, and more to amplify your brand’s reach.',
              },
            ].map((service, index) => (
              <motion.div
                key={index}
