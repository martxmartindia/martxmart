...
// // Sign JWT with jsonwebtoken
// export const signJWT = async (payload: TokenPayload, type: 'access' | 'refresh' = 'access') => {
//   const secret = type === 'access' ? process.env.JWT_SECRET : process.env.JWT_SECRET;
//   if (!secret) {
...
//       throw err;
//     }
//     return { payload: decoded }; // Wrap in payload to match previous jose structure
//   } catch (error: any) {
